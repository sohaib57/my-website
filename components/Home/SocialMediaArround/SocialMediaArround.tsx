      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation Icon={GithubIcon} href={"https://github.com/sohaib57"} />
            {/* Linkedin icon */}
            <IconClickableWithAnimation Icon={LinkedinIcon} href={"https://www.linkedin.com/in/sohaib-ashraf-butt-b36191192/"} />
            {/* Stackoverflow icon */}
            <IconClickableWithAnimation Icon={StackoverflowIcon} href={"https://stackoverflow.com/users/11961514/sohaib"} />
            {/* Youtube Icon */}
          ...
          >
            <a href="mailto:sohaibbutt57@gmail.com" target={"_blank"} rel="noreferrer">
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                sohaibbutt57<span className="text-AAsecondary">@</span>gmail<span className="text-AAsecondary">.</span>com
              </span>
            </a>
          </motion.div>
